...
public class ventanaEstudiante extends javax.swing.JFrame {
   private Grupo s;
     ...
     */
    public ventanaEstudiante(Grupo g,Fecha f) {
        s=g;
        initComponents(g,f);
    }
    ...
    private void initComponents(Grupo g, Fecha f) {
        ...
        textoObservaciones.setColumns(5);
    ...
    public void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {
   ...
   /* public ArrayList<String> getLista( DefaultListModel m){
    ...
    public static void main(String args[]) {
        ...
        new ventanaEstudiante(gr,w).setVisible(true);
    }
